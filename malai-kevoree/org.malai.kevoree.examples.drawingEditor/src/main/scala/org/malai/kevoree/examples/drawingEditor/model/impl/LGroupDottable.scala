...
import org.malai.kevoree.examples.drawingEditor.model.interfaces.{IDot, Dottable, IGroup}
...
protected trait LGroupDottable extends IGroup {
  ...
  private def firstDottable = getShapes.find {
    shape => shape.isInstanceOf[Dottable]
  }
