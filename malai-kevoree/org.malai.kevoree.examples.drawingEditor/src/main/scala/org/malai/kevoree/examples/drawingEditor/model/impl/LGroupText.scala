...
import org.malai.kevoree.examples.drawingEditor.model.interfaces.{IPoint, IText, IGroup}
...
protected trait LGroupText extends IGroup {
  ...
  private def firstIText = getShapes.find {
    shape => shape.isInstanceOf[IText]
  }
