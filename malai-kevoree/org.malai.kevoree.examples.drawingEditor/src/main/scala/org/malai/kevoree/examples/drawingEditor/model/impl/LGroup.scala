...
import org.malai.kevoree.examples.drawingEditor.model.interfaces._
import org.malai.kevoree.examples.drawingEditor.model.interfaces.IFreehand.FreeHandType
import org.malai.kevoree.examples.drawingEditor.model.interfaces.IAxes.{AxesStyle, TicksStyle, PlottingStyle}
import org.malai.kevoree.examples.drawingEditor.model.interfaces.IShape.{LineStyle, FillingStyle, BorderPos}
import org.malai.kevoree.examples.drawingEditor.model.interfaces.IArc.ArcStyle
import org.malai.kevoree.examples.drawingEditor.model.interfaces.IArrow.ArrowStyle
import org.malai.kevoree.examples.drawingEditor.model.interfaces.IText.TextPosition
import org.malai.kevoree.examples.drawingEditor.model.interfaces.IDot.DotStyle
...
with LGroupText with LSetShapes {
  ...
  override def setModified(modified: Boolean) = {
    getShapes.foreach {
      shape => shape.setModified(modified)
    }
  ...
  override def getRotationAngleList(): List[java.lang.Double] = {
    val list = new ArrayList[java.lang.Double]()
    shapes.foreach {
      sh => list.add(sh.getRotationAngle)
    }
    return list
  }
  ...
  override def getHatchingsAngleList(): List[java.lang.Double] = {
    val list = new ArrayList[java.lang.Double]()
    shapes.foreach {
      sh => sh.isInteriorStylable match {
