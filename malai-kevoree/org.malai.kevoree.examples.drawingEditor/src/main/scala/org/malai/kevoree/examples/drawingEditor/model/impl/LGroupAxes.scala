...
import org.malai.kevoree.examples.drawingEditor.model.interfaces.{IPoint, IAxes, IGroup}
...
protected trait LGroupAxes extends IGroup {
  ...
  private def firstIAxes = getShapes.find {
    shape => shape.isInstanceOf[IAxes]
  }
