...
import org.malai.kevoree.examples.drawingEditor.model.interfaces.{IPoint, IStandardGrid, IGroup}
...
protected trait LGroupStdGrid extends IGroup {
  ...
  private def firstIStdGrid = getShapes.find {
    shape => shape.isInstanceOf[IStandardGrid]
  }
