...
import org.malai.kevoree.examples.drawingEditor.model.interfaces.{IPoint, IShape, IGroup}
...
protected trait LGroupShape extends IGroup {
  override def setThickness(thickness: Double) = getShapes.foreach {
    shape => shape.setThickness(thickness)
  }


  override def scale(sx: Double, sy: Double, pos: IShape.Position, bound: Rectangle2D) {
    getShapes.foreach {
      sh => sh.scale(sx, sy, pos, bound)
    }
  }
  ...
  override def isThicknessable() = getShapes.exists {
    shape => shape.isThicknessable
  }


  override def isShowPtsable() = getShapes.exists {
    shape => shape.isShowPtsable
  }


  override def isShowPts() = getShapes.exists {
    shape => shape.isShowPtsable && shape.isShowPts
  }
  ...
  override def isLineStylable() = getShapes.exists {
    shape => shape.isLineStylable
  }
  ...
  override def isBordersMovable() = getShapes.exists {
    shape => shape.isBordersMovable
  }
  ...
  override def setLineColour(lineColour: Color) = getShapes.foreach {
    shape => shape.setLineColour(lineColour)
  }
  ...
  override def hasDbleBord() = getShapes.exists {
    shape => shape.hasDbleBord && shape.isDbleBorderable
  }
  ...
  override def isDbleBorderable() = getShapes.exists {
    shape => shape.isDbleBorderable
  }
  ...
  override def getDbleBordSep(): Double = {
    getShapes.find {
      shape => shape.isDbleBorderable && shape.hasDbleBord
    } match {
  ...
  override def isShadowable() = getShapes.exists {
    shape => shape.isShadowable
  }


  override def hasShadow() = getShapes.exists {
    shape => shape.isShadowable && shape.hasShadow
  }
  ...
  override def getFillingStyle(): IShape.FillingStyle = {
    getShapes.find {
      shape => shape.isInteriorStylable
    } match {
  ...
  override def isFillable() = getShapes.exists {
    shape => shape.isFillable
  }


  override def isInteriorStylable() = getShapes.exists {
    shape => shape.isInteriorStylable
  }
  ...
  override def getFillingCol(): Color = {
    getShapes.find {
      shape => shape.isFillable && shape.isFilled
    } match {
  ...
  override def getHatchingsCol(): Color = {
    getShapes.find {
      shape => shape.isInteriorStylable && shape.getFillingStyle.isHatchings
    } match {
  ...
  override def getGradColStart(): Color = {
    getShapes.find {
      shape => shape.isInteriorStylable && shape.getFillingStyle.isGradient
    } match {
  ...
  override def translate(tx: Double, ty: Double) = getShapes.foreach {
  ...
  override def addToRotationAngle(gravCentre: IPoint, angle: Double) = {
    ...
    getShapes.foreach {
      shape => shape.addToRotationAngle(gc, angle)
    }
  }


  override def setRotationAngle(rotationAngle: Double) = getShapes.foreach {
    shape => shape.setRotationAngle(rotationAngle)
  }


  override def rotate(point: IPoint, angle: Double) = getShapes.foreach {
    shape => shape.rotate(point, angle)
  }
  ...
  override def hasHatchings() = getShapes.exists {
    shape => shape.hasHatchings
  }


  override def hasGradient() = getShapes.exists {
    shape => shape.hasGradient
  }
}
