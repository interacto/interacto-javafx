...
import org.malai.kevoree.examples.drawingEditor.model.interfaces.{IPoint, IFreehand, IGroup}
...
protected trait LGroupFreeHand extends IGroup {
  ...
  private def firstIFreeHand = getShapes.find {
    shape => shape.isInstanceOf[IFreehand]
  }
