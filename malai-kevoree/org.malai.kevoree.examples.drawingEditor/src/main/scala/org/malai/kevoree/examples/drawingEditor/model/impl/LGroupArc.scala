...
import org.malai.kevoree.examples.drawingEditor.model.interfaces.{ILine, IPoint, IArc, IGroup}
...
protected trait LGroupArc extends IGroup {
  ...
  private def firstIArc = getShapes.find {
    shape => shape.isInstanceOf[IArc]
  }
