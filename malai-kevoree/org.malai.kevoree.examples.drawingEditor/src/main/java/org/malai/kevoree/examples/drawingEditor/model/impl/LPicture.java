...
import org.malai.kevoree.examples.drawingEditor.badaboom.BadaboomCollector;
import org.malai.kevoree.examples.drawingEditor.model.interfaces.IPicture;
...
class LPicture extends LPositionShape implements IPicture {
	 ...
	 * @throws java.io.IOException If the picture cannot be loaded.
	 * @since 3.0
	 */
	 ...
	 * @throws java.io.IOException If a problem while reading/writing files occurs.
	 * @throws java.io.IOException If the writing is not possible.
	 * @since 2.0.0
	 */
