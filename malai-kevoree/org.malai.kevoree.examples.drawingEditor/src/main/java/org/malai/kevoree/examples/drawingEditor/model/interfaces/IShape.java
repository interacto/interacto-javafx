...
import org.malai.kevoree.examples.drawingEditor.pst.PSTricksConstants;
...
public interface IShape extends Modifiable, IArrowable {
	 ...
	 * @since 3.0
	 */
	void setArrowStyle(final IArrow.ArrowStyle style, final int position);
	 ...
	 * @since 3.0
	 */
	IArrow.ArrowStyle getArrowStyle(final int position);
