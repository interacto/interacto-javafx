package org.malai.kevoree.examples.drawingEditor.model.interfaces;
...
public interface IGroup extends ISetShapes, ILineArcShape, IText, Dottable, IArc, IAxes, IGrid, IFreehand {
	 ...
	 * @since 3.0
	 */
	List<IArrow.ArrowStyle> getArrowStyleList(int i);
	 ...
	 * @since 3.0
	 */
	List<IDot.DotStyle> getDotStyleList();
	 ...
	 * @since 3.0
	 */
	void setDotStyleList(final List<IDot.DotStyle> values);
	 ...
	 * @since 3.0
	 */
	void setArrowStyleList(final List<IArrow.ArrowStyle> values, final int i);
