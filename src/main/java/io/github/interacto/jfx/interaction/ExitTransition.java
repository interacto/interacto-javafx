...
/**
 * This transition corresponds to the specific JavaFX event/interaction 'MOUSE_EXITED'
 * @author Arnaud BLOUIN
 */
public class ExitTransition extends InputEventTransition<MouseEvent> {
	/**
	 * Creates the transition.
	 */
	public ExitTransition(final OutputState<Event> srcState, final InputState<Event> tgtState) {
	...
	public Set<Object> getAcceptedEvents() {
		return Collections.singleton(MouseEvent.MOUSE_EXITED);
	}
}
