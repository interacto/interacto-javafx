...
public interface InteractionBinder<W, I extends JfxInteraction<D, ?>, D extends InteractionData> extends InteractionBinderBuilder<W, I, D> {
	...
	@Override
	InteractionBinder<W, I, D> on(final ObservableList<? extends W> widgets);
	...
	@Override
	InteractionBinder<W, I, D> help(final HelpAnimation animation);

	@Override
	InteractionBinder<W, I, D> help(final Pane helpPane);

	<C extends Command> InteractionCmdBinder<W, C, I, D> toProduce(final Supplier<C> cmdSupplier);

	<C extends Command> InteractionCmdBinder<W, C, I, D> toProduce(final Function<D, C> cmdSupplier);
}
