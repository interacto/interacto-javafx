...
public abstract class ComboBoxInteractor<A extends Action, I extends JfxInstrument> extends JfxInteractor<A, ComboBoxSelected, I> {
	 ...
	 */
	public ComboBoxInteractor(I ins, Class<A> clazzAction, List<Node> widgets) throws InstantiationException, IllegalAccessException {
		super(ins, false, clazzAction, ComboBoxSelected.class, widgets);
	}
	 ...
	 * @throws IllegalArgumentException If the given interaction or instrument is null.
	 */
	public ComboBoxInteractor(I ins, Class<A> clazzAction, Node... widgets) throws InstantiationException, IllegalAccessException {
		super(ins, false, clazzAction, ComboBoxSelected.class, widgets);
	}
}
