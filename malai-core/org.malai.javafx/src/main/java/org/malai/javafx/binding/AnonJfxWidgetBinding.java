...
public class AnonJfxWidgetBinding<I extends JfxInteraction, N extends JfxInstrument> extends JFxAnonNodeBinding<AnonAction, I, N> {
	...
	public AnonJfxWidgetBinding(final N ins, final boolean exec, final Runnable action, final I interaction,
								...
								final Predicate<I> check, final BiConsumer<AnonAction, I> onEndFct, final Runnable abort, final Runnable feedback,
								final List<Node> widgets, final boolean async) throws InstantiationException, IllegalAccessException {
		super(ins, exec, AnonAction.class, interaction, initActionFct, updateActionFct, check, onEndFct, abort, feedback, widgets, async);
	...
	public AnonJfxWidgetBinding(final N ins, final boolean exec, final Runnable action, final I interaction, final List<Window> widgets,
								...
								final BiConsumer<AnonAction, I> onEndFct, final Runnable abort, final Runnable feedback, final boolean async)
								throws InstantiationException, IllegalAccessException {
		super(ins, exec, AnonAction.class, interaction, widgets, initActionFct, updateActionFct, check, onEndFct, abort, feedback, async);
		anonAction = Objects.requireNonNull(action);
	}

	@Override
	protected void createAction() {
		action = new AnonAction(anonAction);
	}
}
