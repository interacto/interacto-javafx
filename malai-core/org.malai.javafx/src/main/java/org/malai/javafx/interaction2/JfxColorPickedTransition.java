...
/**
 * An FSM transition for colour pickers.
 * @author Arnaud BLOUIN
 */
public class JfxColorPickedTransition extends JfxWidgetTransition<ColorPicker> {
	public JfxColorPickedTransition(final JfxInteraction<?, ColorPicker> interaction, final OutputState<Event> srcState, final InputState<Event> tgtState) {
	...
	protected void action(final Event event) {
		if(event instanceof ActionEvent) {
			interaction.processColorPickerData(event.getSource());
		}
	}
}
