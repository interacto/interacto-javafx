...
/**
 * This widget binding binds an interaction to an action that shows a JComponent.<br>
 * <br>
 ...
 */
public abstract class Interaction2ShowComponent<I extends Interaction, N extends Instrument> extends WidgetBindingImpl<ShowWidget, I, N> {
	 ...
	 * @param interactionClass The class corresponding to the interaction of the widget binding.
	 * @throws IllegalAccessException If no free-parameter constructor is available.
	 * @throws InstantiationException If an error occurs during instantiation of the interaction/action.
	 */
	public Interaction2ShowComponent(final N ins, final boolean exec, final Class<I> interactionClass, final Component component)
