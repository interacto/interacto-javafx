...
namespace org.malai.action {
    ...
    export interface Action {
         ...
         * @return {org.malai.action.Action.RegistrationPolicy} The registration policy.
         */
        getRegistrationPolicy() : Action.RegistrationPolicy;
         ...
         * @return {org.malai.action.Action.ActionStatus} The status of the action.
         * @since 0.2
         */
        getStatus() : Action.ActionStatus;
    ...
    export namespace Action {
         ...
         * @enum
         * @property {org.malai.action.Action.RegistrationPolicy} NONE
         * The action is never registered.
         * @property {org.malai.action.Action.RegistrationPolicy} UNLIMITED
         * The action is registered in the action register. The action is not flushed when the registry wants to free some actions.
         * @property {org.malai.action.Action.RegistrationPolicy} LIMITED
         ...
         * @since 0.2
         * @enum
         * @property {org.malai.action.Action.ActionStatus} CREATED
         * When the action is created but not executed yet.
         * @property {org.malai.action.Action.ActionStatus} EXECUTED
         * When the action has been created and executed one time.
         * @property {org.malai.action.Action.ActionStatus} CANCELLED
         * When the action has been cancelled.
         * @property {org.malai.action.Action.ActionStatus} DONE
         * When the action has been marked as done.
         * @property {org.malai.action.Action.ActionStatus} FLUSHED
