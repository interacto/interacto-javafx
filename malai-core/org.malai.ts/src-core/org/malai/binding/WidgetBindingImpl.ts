...
namespace org.malai.binding {
    ...
    export abstract class WidgetBindingImpl<A extends org.malai.action.ActionImpl, I extends org.malai.interaction2.Interaction<any, any>, N extends org.malai.instrument.Instrument<any>> implements org.malai.binding.WidgetBinding {
         ...
         * @return {org.malai.action.ActionImpl} The created action or null if problems occured.
         */
        map() : A {
            try {
        ...
        /**
         * 
         * @return {org.malai.interaction2.Interaction}
         */
        ...
        /**
         * 
         * @return {org.malai.action.ActionImpl}
         */
        public getAction() : A {
            return this.action;
        }
        ...
        /*private*/ unbindActionAttributesClass(clazz : any) {
            //FIXME
            // java.util.Arrays.stream<any>(clazz.getDeclaredFields()).filter((field) => field.isAnnotationPresent("org.malai.action.AutoUnbind") && "javafx.beans.property.Property".isAssignableFrom(field.getType())).forEach((field) => {
            //     try {
            ...
            // if(superClass != null && superClass !== org.malai.action.ActionImpl && org.malai.action.ActionImpl.isAssignableFrom(superClass)) {
            ...
            if(this.action != null) {
                ...
                if(this.isExecute() && this.action.hadEffect()) {
                    if(this.action != null && (this.action["__interfaces"] != null && this.action["__interfaces"].indexOf("org.malai.undo.Undoable") >= 0 || this.action.constructor != null && this.action.constructor["__interfaces"] != null && this.action.constructor["__interfaces"].indexOf("org.malai.undo.Undoable") >= 0)) {
                        ...
                        throw new org.malai.binding.MustBeUndoableActionException((<any>this.action.constructor));
                    }
                }
                this.action = null;
        ...
        /*private*/ executeAction(act : org.malai.action.Action, async : boolean) {
            if(async) {
        ...
        abstract executeActionAsync(act : org.malai.action.Action);

        afterActionExecuted(act : org.malai.action.Action, ok : boolean) {
            // if(this.loggerAction != null) {
