...
namespace org.malai.error {
    ...
    export class ErrorCatcher {
         ...
         * The notifier object.
         */
        /*private*/ notifier : org.malai.error.ErrorNotifier;
         ...
         * @since 0.2
         */
        public setNotifier(newNotifier : org.malai.error.ErrorNotifier) {
         ...
         * @since 0.2
         */
        public getErrorNotifier() : org.malai.error.ErrorNotifier {
