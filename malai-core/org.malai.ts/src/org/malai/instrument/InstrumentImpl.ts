...
namespace org.malai.instrument {
    /**
     * Creates and initialises the instrument.
     * @class
     * @author Arnaud BLOUIN
     */
    export abstract class InstrumentImpl<T extends org.malai.binding.WidgetBinding> implements org.malai.instrument.Instrument<T> {
        /**
         ...
         * @param {*} action
         */
        public onActionAdded(action : org.malai.action.Action) {
        }
         ...
         * @param {*} action
         */
        public onActionCancelled(action : org.malai.action.Action) {
        }
